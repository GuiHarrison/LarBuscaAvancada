...
$(function() {
	...
	var $baFiltro = $('.div-coluna.filtro'),
		...
		$precoMin2 = $('#field-5'),
		$precoMax2 = $('#field-6'),
		$botaoComAl = $('.botao-comprar');

	$botaoComAl.click(function(e) {
		e.preventDefault();
		// $(this).toggleClass('ativo');

		if ($(this).hasClass('ativo')) {
			$botaoComAl.removeClass('ativo');
		} else { 
			$botaoComAl.removeClass('ativo');
			$(this).addClass('ativo');
		}
